...
public interface ISeries {
    ...
    /**
     * Set the series according to an XY data set rather than an individual
     * x and y data series.
     * @param dataset Data set containing x and y values.
     */
    void setXYSeries(IXYDataset dataset);
